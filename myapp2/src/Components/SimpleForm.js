...
import { addUserDetails, getUser, editUserDetails } from "../apis/api";
...
function SimpleForm() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    await addUserDetails(inputValues, incValues, itnValues);
    setInputValue({
      day: "",
      city: "",
      tag: "",
  ...
  return (
    <>
      <div className="form-container d-flex justify-content-center align-items-center flex-column">
        <div className="d-flex delbutton">
        ...
        <div className="sign-up-form col-4">
          ...
          <div className="mt-3 text-center editform">
            want to Edit or Delete the Form ?{" "}
